      ...
      'webshop' => {
        ...
        'deploy' => {
          ...
          'labels'   => [
            ...
            'traefik.http.middlewares.fhg-shop.redirectregex.regex=^https?://(.+).fhg.de/(.*)',
            'traefik.http.middlewares.fhg-shop.redirectregex.replacement=https://$${1}.fraunhofer.de/$${2}',
            'traefik.http.middlewares.fhg-shop.redirectregex.permanent=true',
            'traefik.http.routers.webshop.middlewares=fhg-shop@docker',
